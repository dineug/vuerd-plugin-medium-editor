/**
 * image upload overridden
 * https://github.com/yabwe/medium-editor/blob/master/src/js/extensions/file-dragging.js
 */
import Medium from "@/components/MediumEditor.vue";
(function() {
  "use strict";
  ...
  const FileDragging = MediumEditor.Extension.extend({
    ...
    insertImageFile: function(file) {
      ...
      if (
        Medium.prototype.imageUpload &&
        typeof Medium.prototype.imageUpload === "function"
      ) {
        Medium.prototype.imageUpload(file, url => {
